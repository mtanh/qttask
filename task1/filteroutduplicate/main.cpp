...
struct WaterPressurePoints
{
     ...
     *
     * Main idea is determining whether two data points in
     * coordinates are close enough by comparing the Euclidean
     * between them with the given threshold
     *
     */
 ...
 * that helps the QSet ignore the coordinates that are close enough to the processed point
 *
*/
