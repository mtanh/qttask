...
OtherWallsGroundwaterWidget::OtherWallsGroundwaterWidget(GroundwaterModel* model, QWidget *parent)
...
void OtherWallsGroundwaterWidget::setupUi()
{
    ...
    connect(m_includeWaterTableCheck, &QCheckBox::toggled, this, &OtherWallsGroundwaterWidget::includeWaterTableToggled);
    connect(m_constantRadio, &QRadioButton::toggled, this, &OtherWallsGroundwaterWidget::constantToggled);
    connect(m_differentialRadio, &QRadioButton::toggled, this, &OtherWallsGroundwaterWidget::differentialToggled);
    connect(m_applyToAllCheck, &QCheckBox::toggled, this, &OtherWallsGroundwaterWidget::applyToAllToggled);
    ...
    setTabOrder(m_frontFaceWaterElevationEdit, m_applyToAllCheck);

    mainLayout->setContentsMargins(10, 10, 10, 10);
    groupLayout->setContentsMargins(5, 5, 5, 5);
}

void OtherWallsGroundwaterWidget::setInitialState()
{
...
void OtherWallsGroundwaterWidget::updateControls()
{
